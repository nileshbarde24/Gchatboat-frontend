...
import { startConversation, selectedFilesStartConversation, analyzeImage, analyzeImageLocalOrUrl, webScrap, generateRelevantSentence } from "../controller/chatController.js"
...
router.post('/generate-relevant-sentence', generateRelevantSentence);
