...
// SQL Connection:
// @ts-ignore
async function createDBConnection(req: Request, res: Response) {
    // @ts-ignore
...
// update helper:
async function updateConnection(_id: any, data: any) {
...
// Update Connection:
// @ts-ignore   
async function updateDBConnection(req: Request, res: Response) {
    try {
        // @ts-ignore
        const userId = req?.userId;
...
// SQL History:
async function addSQLHistory(qaPairs: any) {
    try {
...
async function getSQLChatHistory(req: Request, res: Response) {
    // @ts-ignore
    const userId = req?.userId;
...
// Chat over SQL data:
async function chatWithSQL(req: Request, res: Response) {
...
async function getAllConnections(req: Request, res: Response) {
    // @ts-ignore
    const userId = req?.userId;
    try {
