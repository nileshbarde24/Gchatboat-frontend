...
let secret;
// @ts-ignore
async function getTwoFactorSetup(req: Request, res: Response) {
  try {
    // @ts-ignore
...
// @ts-ignore
async function verifyTwoFactorSetup(req: Request, res: Response) {
...
// @ts-ignore
async function verifyTwoFactorCode(req: Request, res: Response) {
...
// @ts-ignore
async function updateToFaUserById(req: Request, res: Response) {
  try {
...
// @ts-ignore
async function getUserByEmailPassword(req: Request, res: Response) {
...
// @ts-ignore
 async function sendOtpForAuthMobile(req: Request, res: Response) {
...
// @ts-ignore
async function verifyOtpForAuthMobile(req: Request, res: Response) {
...
export {
  ...
  updateMFAUserByEmail,
  sendOtpForAuthMobile,
  verifyOtpForAuthMobile,
  removeMFA
