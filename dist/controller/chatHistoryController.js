...
async function addTopicForChatHistory(req, res) {
    try {
...
async function addTopicForMultipleFileChatHistory(req, res) {
    try {
        const { topicName, userId, uploadedFileId, isGlobal } = req.body;
...
async function getPerticularPdfFileHistory(req, res) {
    try {
...
async function getTopicChatHistoryById(req, res) {
    try {
...
async function getTopicMultipleChatHistoryByIds(req, res) {
    try {
...
async function getMultiplePdfFileHistory(req, res) {
    try {
...
async function getHistoryTopicByUserId(req, res) {
    try {
...
//# sourceMappingURL=chatHistoryController.js.map