// @ts-ignore
const ForgotPasswordOTP = (SENDER_EMAIL, email, otp) => {
    return {
        from: SENDER_EMAIL,
        to: email,
        subject: "Forgot Password OTP",
        text: "Your OTP for Forgot Password",
        html: `
      <html>
        <head>
          ...
          <table style="width: 100%; height: 100vh; border: 0.1px solid black;">
                ...
                <table style="width: 90%; margin-left: 5%; height: 100%; background-color: #2626EA; margin-top: 25px">
                  <tr style="width: 100%; height: 100%">
                    <td style="width: 100%; background-repeat: no-repeat; background-size: 100% 100%; background-color: gray;">
                      <p style="margin-left: 12px; color: white; font-family: 'HK Grotesk', sans-serif; font-weight: bold; font-size: 25px;">Forgot Password OTP</p>
                    </td>
                  </tr>
                </table>
              </td>
            ...
            <tr>
              <td style="font-size: 18px; color: black; padding-left: 5%; padding-top: 5%; padding-right: 5%; font-family: 'HK Grotesk', sans-serif;">
                <p>Dear User,</p> You have requested a One-Time Password (OTP) to reset your password for Chat-bot. Please use the following OTP to reset your password:
                <br />
                <br />
...
//# sourceMappingURL=ForgotPasswordOTP.js.map